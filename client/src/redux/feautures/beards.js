...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case "beards/getAllBeards/pending/fulfilled":
      return {...state, loading: false, beards: action.payload}
    case "beards/getAllBeards/pending/rejected":
    ...
    //   return {...state, loading: false, beards: action.error}
    default:
      return state
  }
}
...
//
//     const res = await fetch(`/beards/${id}`)
//     const json = await res.json()
//
